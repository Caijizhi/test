...
print('羽绒服占比：',format(round(num_yurong/amout,4),'.2%'))
print('牛仔裤占比：',format(round(num_niuzaiku/amout,4),'.2%'))
print('风衣占比：',format(round(num_fengyi/amout,4),'.2%'))
print('皮草占比：',format(round(num_picao/amout,4),'.2%'))
print('T血占比：',format(round(num_t/amout,4),'.2%'))
print('衬衫占比：',format(round(num_shirt/amout,4),'.2%'))
